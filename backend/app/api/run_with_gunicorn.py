#!/usr/bin/env python
"""
Start ZeRAG server with Gunicorn
"""
...
from app.api.utils_api import display_splash_screen, check_env_file
from app.api.config import global_args
...
def main():
    ...
    from app.api.config import initialize_config

    initialize_config()

    # Set Gunicorn mode flag for lifespan cleanup detection
    os.environ["ZERAG_GUNICORN_MODE"] = "1"
    ...
    if (
        ...
        print("     zerag-gunicorn --workers 2")
    ...
    print("🚀 Starting ZeRAG with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from app.api import gunicorn_config
        ...
        def load(self):
            ...
            from app.api.zerag_server import get_application
    ...
    if workers_count > 1:
        ...
        os.environ["ZERAG_MAIN_PROCESS"] = "1"
