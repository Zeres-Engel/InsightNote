"""
Utility functions for the ZeRAG API.
"""
...
from app.api import __api_version__ as api_version
from app.core import __version__ as core_version
from app.core.constants import (
    DEFAULT_FORCE_LLM_SUMMARY_ON_MERGE,
)
from fastapi import HTTPException, Security, Request, Response, status, Header
...
def get_combined_auth_dependency(api_key: Optional[str] = None):
    ...
    async def combined_dependency(
        ...
        api_key_header_value: Optional[str] = Header(default=None, alias="X-API-Key", include_in_schema=False),
    ):
...
def display_splash_screen(args: argparse.Namespace) -> None:
    """
    Display a colorful splash screen showing ZeRAG server configuration
    ...
    line1_text = f"ZeRAG Server v{core_version}/{api_version}"
    ...
    ASCIIColors.yellow(f"{ollama_server_infos.ZERAG_MODEL}")
