...
class QueryRequest(BaseModel):
    ...
    enable_rerank: bool = Field(
        default=True,
        description="Enable reranking for retrieved text chunks. This is mandatory for this system.",
    )
    ...
    vector_score: Optional[float] = Field(
        default=None,
        description="Cosine similarity score threshold for vector retrieval. Overrides default.",
    )

    rerank_score: Optional[float] = Field(
        default=None,
        description="Minimum rerank score threshold for keeping reranked chunks. Overrides default.",
    )
    ...
    def to_query_params(self, is_stream: bool) -> "QueryParam":
        ...
        param.enable_rerank = True  # Mandatory reranking
