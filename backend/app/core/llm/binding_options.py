...
# in ZeRAG. It provides a standardized framework for:
#
...
class BindingOptions:
    ...
    def generate_dot_env_sample(cls):
        """
        Generate a sample .env file for all ZeRAG binding options.
        ...
        sample_top = (
            ...
            + "\n"
            + (
                "# Autogenerated .env entries list for ZeRAG binding options\n"
                "#\n"
                "# To generate run:\n"
                "# $ python -m zerag.llm.binding_options\n"
            )
            + "#" * 80
            + "\n"
        )
        ...
        sample_bottom = (
            ("#\n# End of .env entries for ZeRAG binding options\n")
            + "#" * 80
            + "\n"
        )
...
#
# Usage:
#   python -m zerag.llm.binding_options           # Generate .env sample
#   python -m zerag.llm.binding_options test      # Test argument parsing
#
# =============================================================================
