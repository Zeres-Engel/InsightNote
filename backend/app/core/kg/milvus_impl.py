...
import numpy as np
from app.core.utils import logger, compute_mdhash_id
...
class MilvusVectorDBStorage(BaseVectorStorage):
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if self.namespace.endswith("entities"):
            ...
            description = "ZeRAG entities vector storage"
            ...
            description = "ZeRAG relationships vector storage"
            ...
            description = "ZeRAG chunks vector storage"
            ...
            description = "ZeRAG generic vector storage"
    ...
    def __post_init__(self):
        ...
        # which is the RECOMMENDED method for framework integration (e.g., MultiRAG).
        #
        ...
        search_params = {
            ...
            "params": {
                **search_params_base.get("params", {}),
                "radius": score_threshold if score_threshold is not None else 0.2,
            },
        }
