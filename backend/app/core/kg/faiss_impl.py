...
from app.core.base import BaseVectorStorage
...
class FaissVectorDBStorage(BaseVectorStorage):
    """
    A Faiss-based Vector DB Storage for ZeRAG.
    ...
    async def query(
        ...
        current_score_threshold = score_threshold if score_threshold is not None else 0.2
        ...
        for dist, idx in zip(distances, indices):
            ...
            if dist < current_score_threshold:
                continue
    ...
    def client_storage(self):
        # Return whatever structure ZeRAG might need for debugging
