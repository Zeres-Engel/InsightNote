...
This tool cleans up ZeRAG's LLM query cache from KV storage implementations. It specifically targets query caches generated during RAG query operations (modes: `mix`, `hybrid`, `local`, `global`), including both query and keywords caches.
...
```
============================================================
LLM Query Cache Cleanup Tool - ZeRAG
============================================================
