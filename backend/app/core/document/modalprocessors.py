...
from app.core.kg.shared_storage import get_namespace_data, get_pipeline_status_lock
from app.core.operate import extract_entities, merge_nodes_and_edges
...
class BaseModalProcessor:
    ...
    def __init__(
        ...
        # Use ZeRAG's storage instances
        self.text_chunks_db = zerag.text_chunks
        self.chunks_vdb = zerag.chunks_vdb
        self.entities_vdb = zerag.entities_vdb
        self.relationships_vdb = zerag.relationships_vdb
        self.knowledge_graph_inst = zerag.chunk_entity_relation_graph

        # Use ZeRAG's configuration and functions
        self.embedding_func = zerag.embedding_func
        self.llm_model_func = zerag.llm_model_func
        self.global_config = asdict(zerag)
        self.hashing_kv = zerag.llm_response_cache
        self.tokenizer = zerag.tokenizer
    ...
    def set_content_source(self, content_source: Any, content_format: str = "auto"):
        ...
        logger.debug(f"Content source set with format: {content_format}")
...
class ImageModalProcessor(BaseModalProcessor):
    ...
    def __init__(
        ...
        Args:
            ...
            context_extractor: Context extractor instance
        """
        super().__init__(zerag, modal_caption_func, context_extractor)
