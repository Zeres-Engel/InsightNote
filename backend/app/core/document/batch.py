...
if TYPE_CHECKING:
    from .config import MultiRAGConfig


class BatchMixin:
    """BatchMixin class containing batch processing functionality for MultiRAG"""

    # Type hints for mixin attributes (will be available when mixed into MultiRAG)
    config: "MultiRAGConfig"
    logger: logging.Logger

    # Type hints for methods that will be available from other mixins
    async def _ensure_zerag_initialized(self) -> None: ...
