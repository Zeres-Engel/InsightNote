"""
Configuration classes for MultiRAG
...
class MultiRAGConfig:
    """Configuration class for MultiRAG with environment variable support"""

    # Directory Configuration
    # ---
    working_dir: str = field(default=get_env_value("WORKING_DIR", "./data", str))
    ...
    """Whether to use full file path (True) or just basename (False) for file references in ZeRAG."""
