"""
Centralized configuration constants for ZeRAG.

This module defines default values for configuration constants used across
different parts of the ZeRAG system. Centralizing these values ensures
